    ...
    <div className="container mx-auto flex justify-between items-center px-4">
      ...
      <div className="flex space-x-4 flex-1 justify-end">
        <div className="relative group">
          ...
          <span className="absolute left-1/2 transform -translate-x-1/2 top-9 w-max px-2 py-1 text-sm text-blue-200 bg-black rounded-md opacity-0 group-hover:opacity-100 transition-opacity">
            Resume
          </span>
        </div>
        <div className="relative group">
          ...
          <span className="absolute left-1/2 transform -translate-x-1/2 top-9 w-max px-2 py-1 text-sm text-blue-300 bg-black rounded-md opacity-0 group-hover:opacity-100 transition-opacity">
            College
          </span>
        </div>
        <div className="relative group">
