...
export interface Skill {
  cat: number; // 0: Programming Languages, 1: Frameworks/Libraries, 2: Tools/Software, 3: Concepts, 4: Soft Skills
  name: string;
  icon: string;
}
...
export const skills: Skill[] = [
  ...
  { cat: 0, name: "Rust", icon: "/assets/skills/c.png" },
  { cat: 0, name: "Java", icon: "/assets/skills/c.png" },
  { cat: 0, name: "C#", icon: "/assets/skills/c.png" },
  { cat: 0, name: "Python", icon: "/assets/skills/c.png" },
  { cat: 0, name: "Ruby", icon: "/assets/skills/c.png" },
  { cat: 0, name: "HTML", icon: "/assets/skills/c.png" },
  { cat: 0, name: "CSS", icon: "/assets/skills/c.png" },
  { cat: 0, name: "JavaScript", icon: "/assets/skills/c.png" },
  { cat: 0, name: "TypeScript", icon: "/assets/skills/c.png" },
  { cat: 0, name: "SQL", icon: "/assets/skills/c.png" },
  { cat: 0, name: "Swift", icon: "/assets/skills/c.png" },
  { cat: 0, name: "Kotlin", icon: "/assets/skills/c.png" },
  { cat: 0, name: "Bash", icon: "/assets/skills/c.png" },
  { cat: 1, name: "React", icon: "/assets/skills/c.png" },
  { cat: 1, name: "Next.js", icon: "/assets/skills/c.png" },
  { cat: 1, name: "Vue.js", icon: "/assets/skills/c.png" },
  { cat: 1, name: "Tailwind CSS", icon: "/assets/skills/c.png" },
  { cat: 1, name: "Node.js", icon: "/assets/skills/c.png" },
  { cat: 1, name: "Express.js", icon: "/assets/skills/c.png" },
  { cat: 1, name: "GraphQL", icon: "/assets/skills/c.png" },
  { cat: 1, name: "Spring Boot", icon: "/assets/skills/c.png" },
  { cat: 1, name: "Rails", icon: "/assets/skills/c.png" },
  { cat: 1, name: "Flask", icon: "/assets/skills/c.png" },
  { cat: 1, name: "Django", icon: "/assets/skills/c.png" },
  { cat: 1, name: "PyTorch", icon: "/assets/skills/c.png" },
  { cat: 1, name: "Selenium", icon: "/assets/skills/c.png" },
  { cat: 1, name: "Bootstrap", icon: "/assets/skills/c.png" },
  { cat: 2, name: "Git", icon: "/assets/skills/c.png" },
  { cat: 2, name: "Jira", icon: "/assets/skills/c.png" },
  { cat: 2, name: "VS Code", icon: "/assets/skills/c.png" },
  { cat: 2, name: "PostgreSQL", icon: "/assets/skills/c.png" },
  { cat: 2, name: "Apache HBase", icon: "/assets/skills/c.png" },
  { cat: 2, name: "DocumentDB", icon: "/assets/skills/c.png" },
  { cat: 2, name: "Docker", icon: "/assets/skills/c.png" },
  { cat: 2, name: "Firebase", icon: "/assets/skills/c.png" },
  { cat: 2, name: "Google Cloud", icon: "/assets/skills/c.png" },
  { cat: 2, name: "FFmpeg", icon: "/assets/skills/c.png" },
  { cat: 2, name: "Microsoft Excel", icon: "/assets/skills/c.png" },
  { cat: 2, name: "Unity", icon: "/assets/skills/c.png" },
  { cat: 2, name: "MATLAB", icon: "/assets/skills/c.png" },
  { cat: 2, name: "R", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Full Stack Development", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Agile Methodologies", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Version Control", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Data Structures", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Algorithms", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Operating Systems", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Networking Protocols", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Cybersecurity", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Database Management Systems (DMBS)", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Unified Modeling Language (UML)", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Cloud Computing", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Quantum Computing", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Data Analytics", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Artifical Intelligence (AI)", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Machine Learning (ML)", icon: "/assets/skills/c.png" },
  { cat: 4, name: "Communication", icon: "/assets/skills/c.png" },
  { cat: 4, name: "Active Listening", icon: "/assets/skills/c.png" },
  { cat: 4, name: "Public Speaking", icon: "/assets/skills/c.png" },
  { cat: 4, name: "Collaboration", icon: "/assets/skills/c.png" },
  { cat: 4, name: "Conflict Resolution", icon: "/assets/skills/c.png" },
  { cat: 4, name: "Innovation", icon: "/assets/skills/c.png" },
  { cat: 4, name: "Adaptability", icon: "/assets/skills/c.png" },
  { cat: 4, name: "Leadership", icon: "/assets/skills/c.png" },
  { cat: 4, name: "Management", icon: "/assets/skills/c.png" },
  { cat: 4, name: "Mentoring", icon: "/assets/skills/c.png" },
  { cat: 4, name: "Time Management", icon: "/assets/skills/c.png" },
  { cat: 4, name: "Integrity", icon: "/assets/skills/c.png" },
  { cat: 4, name: "Resilience", icon: "/assets/skills/c.png" },
  { cat: 4, name: "Stress Management", icon: "/assets/skills/c.png" },
];
