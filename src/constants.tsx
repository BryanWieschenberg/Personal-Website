...
export const skills: Skill[] = [
  ...
  { cat: 0, name: "C#", icon: "/assets/skills/cs.png" },
  { cat: 0, name: "Java", icon: "/assets/skills/java.png" },
  { cat: 0, name: "Python", icon: "/assets/skills/py.png" },
  { cat: 0, name: "Ruby", icon: "/assets/skills/rb.png" },
  { cat: 0, name: "HTML", icon: "/assets/skills/html.png" },
  { cat: 0, name: "CSS", icon: "/assets/skills/css.png" },
  { cat: 0, name: "JavaScript", icon: "/assets/skills/js.png" },
  { cat: 0, name: "TypeScript", icon: "/assets/skills/ts.png" },
  { cat: 0, name: "SQL", icon: "/assets/skills/sql.png" },
  { cat: 1, name: "React", icon: "/assets/skills/react.png" },
  { cat: 1, name: "Next.js", icon: "/assets/skills/next.png" },
  { cat: 1, name: "Vue.js", icon: "/assets/skills/vue.png" },
  { cat: 1, name: "Tailwind CSS", icon: "/assets/skills/tw.png" },
  { cat: 1, name: "Node.js", icon: "/assets/skills/node.png" },
  { cat: 1, name: "Spring Boot", icon: "/assets/skills/sb.png" },
  { cat: 1, name: "Rails", icon: "/assets/skills/rails.png" },
  { cat: 1, name: "Flask", icon: "/assets/skills/flask.png" },
  { cat: 1, name: "Django", icon: "/assets/skills/dj.png" },
  { cat: 1, name: "Selenium", icon: "/assets/skills/se.png" },
  { cat: 1, name: "Bootstrap", icon: "/assets/skills/bs.png" },
  { cat: 2, name: "Git", icon: "/assets/skills/git.png" },
  { cat: 2, name: "Jira", icon: "/assets/skills/jira.png" },
  { cat: 2, name: "VS Code", icon: "/assets/skills/vscode.png" },
  { cat: 2, name: "PostgreSQL", icon: "/assets/skills/psql.png" },
  { cat: 2, name: "MongoDB", icon: "/assets/skills/mdb.png" },
  { cat: 2, name: "Google Cloud", icon: "/assets/skills/gcp.png" },
  { cat: 2, name: "Firebase", icon: "/assets/skills/fb.png" },
  { cat: 2, name: "Docker", icon: "/assets/skills/docker.png" },
  { cat: 2, name: "Microsoft Excel", icon: "/assets/skills/excel.png" },
  { cat: 2, name: "Unity", icon: "/assets/skills/unity.png" },
  { cat: 2, name: "MATLAB", icon: "/assets/skills/matlab.png" },
  { cat: 2, name: "R", icon: "/assets/skills/r.png" },
  { cat: 2, name: "UML", icon: "/assets/skills/uml.png" },
  { cat: 3, name: "Communication", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Active Listening", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Public Speaking", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Collaboration", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Conflict Resolution", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Innovation", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Adaptability", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Leadership", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Management", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Mentoring", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Time Management", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Integrity", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Resilience", icon: "/assets/skills/c.png" },
  { cat: 3, name: "Stress Management", icon: "/assets/skills/c.png" },
];
