            ...
            <div className="flex items-center justify-center slogan">
                <div className="flex flex-col slogan text-center">
                    <div className="overflow-hidden min-h-[6rem] lg:min-h-[10rem]">
                        <h2
                            className={`animate-fadeInLeft mt-3 mb-5 lg:mb-6 text-[1.5rem] lg:text-5xl`}
                        >
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center container mx-auto px-4 lg:px-20 max-w-7xl">
                    <div className="text-center lg:text-left lg:w-1/2 flex flex-col items-center lg:items-start">
                        ...
                        <p className="mt-4 text-base lg:text-3xl">
                            I am a{' '}
                            <span className="font-semibold text-[#b8e4ff]">
                            ...
                            <br />
                            as an aspiring{' '}
                            <span className="font-semibold text-[#b8e4ff]">Software Engineer</span>.
                        </p>
                        ...
                        <div className="mt-6 hidden lg:flex flex-row justify-start space-x-4">
                            <a
                                href="top"
                                onClick={LearnMore}
                                className="px-3 py-2 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600 text-xl"
                            >
                                Learn More
                            </a>
                            <a
                                href="top"
                                onClick={ContactMe}
                                className="px-3 py-2 border border-blue-500 text-blue-500 rounded-lg shadow-md hover:bg-blue-600 hover:text-white text-xl"
                            >
                                Contact Me
                            </a>
                        </div>
