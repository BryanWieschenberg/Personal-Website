      ...
      <div className="container mx-auto px-4 lg:px-20 py-10">
        {largeProjects.length > 0 && (
          <section className="mb-12">
            <h2 className="text-3xl lg:text-5xl text-center font-extrabold mb-6 text-[#4fbdf1]  relative bg-gradient-to-r drop-shadow-[7px_7px_1.5px_rgba(60,60,150,1)] text-transparent">Large-Scale Projects</h2>
        ...
        {mediumProjects.length > 0 && (
          <section className="mb-12">
            <h2 className="text-3xl lg:text-5xl text-center font-extrabold mb-6 text-[#4ff192]  relative bg-gradient-to-r drop-shadow-[7px_7px_1.5px_rgba(20,120,20,1)] text-transparent">Medium-Scale Projects</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {smallProjects.length > 0 && (
          <section className="mb-12">
            <h2 className="text-3xl lg:text-5xl text-center font-extrabold mb-6 text-[#f1e24f] relative bg-gradient-to-r drop-shadow-[7px_7px_1.5px_rgba(120,120,30,1)] text-transparent">Small-Scale Projects</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
