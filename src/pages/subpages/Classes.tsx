...
const Classes = () => {
  ...
  return (
    <>
      ...
      <h1 ref={ref} className={`roles-text lg:mb-2 pt-4 lg:pt-10 text-2xl lg:text-6xl font-bold pb-4 drop-shadow-[7px_7px_1.5px_rgba(30,30,160,1)] text-center relative text-[#8580e7] bg-clip-text opacity-100`}>
        Classes I've Taken:
      </h1>
