    ...
    return (
        <div className="container mx-auto px-4 lg:px-20 mb-6 overflow-x-hidden">
            ...
            <div className="relative lg:mt-4">
                <div
                    className={`absolute left-1/2 transform -translate-x-1/2 top-0 w-3 h-[98%] bg-[#1e65ff] transition-opacity duration-1000 ${
                ...
                <div className="w-full max-w-4xl mx-auto px-4">
                    {items.map((exp, index) => (
                        <div key={index} className="mb-[9px] relative">
                            <div
                                className={`transition-opacity duration-300 ease-in-out ${exp.visible ? 'translate-x-0 opacity-100' : 'translate-x-[150px] opacity-0'}`}
                            >
                                <div
